<template>
  ...
  >
    ...
    <div class="step" :class="{ active: 0 == currStep }" data-step-no="0">
      <p class="content">But where are Cudi's hums located?</p>
      <p class="content">
        Are they mostly concentrated at the beginnings and ends of each song, or
    ...
    <div class="step" :class="{ active: 3 == currStep }" data-step-no="3">
      ...
      <div class="is-flex is-flex-direction-column">
        ...
        <p
          v-if="unclicked"
          class="mb-0 mt-3 heading is-size-7 has-text-grey has-text-centered"
        >
          👆 Click me!
        </p>
      </div>
    ...
    <div class="step" :class="{ active: 7 == currStep }" data-step-no="7">
      ...
      <p class="content">
        Because songs differ in length, this method allows us to search for
        hums' locations in a standardized and consistent way.
      </p>
    </div>
